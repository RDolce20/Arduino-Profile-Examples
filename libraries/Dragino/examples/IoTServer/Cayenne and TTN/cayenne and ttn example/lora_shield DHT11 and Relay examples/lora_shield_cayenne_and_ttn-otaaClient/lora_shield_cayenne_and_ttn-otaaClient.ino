...
// 0x70.
static const u1_t PROGMEM APPEUI[8]={ 0xE3, 0x42, 0x03, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 };
void os_getArtEui (u1_t* buf) { memcpy_P(buf, APPEUI, 8);}

// This should also be in little endian format, see above.
static const u1_t PROGMEM DEVEUI[8]={ 0xA8, 0xA8, 0xB4, 0x40, 0xE5, 0x85, 0xB1, 0x00 };
...
static const u1_t PROGMEM APPKEY[16] ={ 0x6C, 0xC6, 0x65, 0xB8, 0x01, 0xD2, 0xAC, 0x98, 0xB9, 0x26, 0xE7, 0xF9, 0xE1, 0xCD, 0x57, 0x85 };
